...
MASTER = "rackspacev2-salt-arch20139-a"

PROVIDER_MODULE = "bootmachine.contrib.providers.rackspace_openstack_v2"
SERVERS = [
    {"servername": "rackspacev2-salt-arch20139-a",
     "roles": ["salt-master"],
     "flavor": "2",
     "image": "Arch 2013.9",
     "distro_module": "bootmachine.contrib.distros.rackspace_arch_20139"},
    {"servername": "rackspacev2-salt-arch20139-b",
